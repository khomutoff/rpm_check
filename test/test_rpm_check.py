...
class RpmCheckTest(unittest.TestCase):
    ...
    def test_pkg_is_installed(self):
       ...
       existing_pkgs, missing_pkgs = rpm_check.is_installed(["python", "kernel"])
    ...
    def test_pkg_is_not_installed(self):
        ...
        existing_pkgs, missing_pkgs = rpm_check.is_installed(["kenel"])
    ...
    def test_one_of_pkgs_is_not_installed(self, mock_db_match):
        ...
        existing_pkgs, missing_pkgs = rpm_check.is_installed(["python", "kenel"])
        self.assertEqual(missing_pkgs, ['kenel'])
    ...
    @patch("rpm_check.is_installed", return_value=([],['httpd']))
